...
export interface Entity { name: string; ownership_chain: string; declaration_kind: string; file: string; discriminator: number; start_line: number; start_column: number; end_line: number; end_column: number; attributes: Record<string, unknown> }
