...
Use `SYSVISTA_SCALE_OUTPUT`, `SYSVISTA_SCALE_SEED`, `SYSVISTA_SCALE_SIZES`, or
`SYSVISTA_ANALYZER_HEAP_MB` to override the temporary directory, seed, selected sizes,
or analyzer heap while investigating results.
